...
This means one can have an always-on miad instance running, and another local miad/mia-qt instance which connects to this node and receives blocks from it.
