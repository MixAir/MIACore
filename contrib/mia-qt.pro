...
RESOURCES += src/qt/mia.qrc src/qt/mia_locale.qrc

TRANSLATIONS += src/qt/locale/mia_bg.ts \
                src/qt/locale/mia_de.ts \
                src/qt/locale/mia_en.ts \
                src/qt/locale/mia_es.ts \
                src/qt/locale/mia_fi.ts \
                src/qt/locale/mia_fr.ts \
                src/qt/locale/mia_it.ts \
                src/qt/locale/mia_ja.ts \
                src/qt/locale/mia_pl.ts \
                src/qt/locale/mia_pt.ts \
                src/qt/locale/mia_ru.ts \
                src/qt/locale/mia_sk.ts \
                src/qt/locale/mia_sv.ts \
                src/qt/locale/mia_vi.ts \
                src/qt/locale/mia_zh_CN.ts \
                src/qt/locale/mia_zh_TW.ts
