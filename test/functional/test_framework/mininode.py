...
from test_framework.miaconfig import INITIAL_HASH_UTXO_ROOT, INITIAL_HASH_STATE_ROOT
...
class CTransaction(object):
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in miad
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class NodeConnCB(object):
    """Callback and helper functions for P2P connection to a miad node.
