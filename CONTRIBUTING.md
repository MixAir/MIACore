...
confused with overall MIA Network Protocol consensus changes.
...
Patches that change MIA consensus rules are considerably more involved than
...
Where a patch set proposes to change the MIA consensus, it must have been
