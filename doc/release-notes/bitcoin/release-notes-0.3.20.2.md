...
worse as mia upgraded, so I cherry-picked the bug fix and created a minor release yesterday.
...
If you have already downloaded version 0.3.20.1, please either add this to your mia.conf file:
