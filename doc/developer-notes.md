...
MIA Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 36660.
...
However, in open source software such as MIA Core, where everyone uses
...
pay attention to for reviewers of MIA Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MIA Core uses tinyformat, which is type safe. Leave them out to avoid confusion
