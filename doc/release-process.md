...
* Update translations, see [translation_process.md](https://github.com/MixAir/mia/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/MixAir/gitian.sigs.git
	git clone https://github.com/MixAir/mia-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/MixAir/MIACore.git

### MIA Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign MIA Core for Linux, Windows, and OS X:

	./bin/gbuild --commit mia=v${VERSION} ../mia/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit mia=v${VERSION} ../mia/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit mia=v${VERSION} ../mia/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../mia/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [mia-detached-sigs](https://github.com/MixAir/mia-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
### After 3 or more mia have gitian-built and their results match:
...
- Announce the release:
  ...
  - Release on MIA forum: https://www.mixair.info/forum/topic/official-announcements.54/

  - MIA-development mailing list

  - Update title of #MixAir on Freenode IRC

  - Optionally reddit /r/MixAir, ... but this will usually sort out itself

- Notify flare so that he can start building [the PPAs](https://launchpad.net/~mixair.info/+archive/ubuntu/mia)
