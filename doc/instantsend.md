...
* WebSocket: [https://github.com/MixAir/insight-api-mia#web-socket-api](https://github.com/MixAir/insight-api-mia#web-socket-api)
* API: [https://github.com/MixAir/insight-api-mia#instantsend-transactions](https://github.com/MixAir/insight-api-mia#instantsend-transactions)
...
By default, the MIA Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MIA Core daemon:
