...
In order to support loading of multiple wallets in mia-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mia.cpp.
...
Changes to mia.cpp
----------------------
mia.cpp is the entry point into mia-qt, and as such, will require some minor modifications to provide hooks for
