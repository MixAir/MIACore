...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MIA:
            return QString("tMIA");
        case mMIA:
            return QString("mtMIA");
        case uMIA:
            return QString::fromUtf8("μtMIA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MIA:
            return QString("MIA");
        case mMIA:
            return QString("Milli-MIA (1 / 1" THIN_SP_UTF8 "000)");
        case uMIA:
            return QString("Micro-MIA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MIA:
            return QString("TestMIAs");
        case mMIA:
            return QString("Milli-TestMIA (1 / 1" THIN_SP_UTF8 "000)");
        case uMIA:
            return QString("Micro-TestMIA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
