    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MIA-light"), QVariant("light"));
    ui->theme->addItem(QString("MIA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MIA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MIA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MIA-traditional"), QVariant("trad"));
