...
const char* BIP71_MIMETYPE_PAYMENT = "application/mia-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mia-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mia-paymentrequest";
...
//
// OSX-specific way of handling mia: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject* object, QEvent* event)
{
    // clicking on mia: URIs creates FileOpen events on the Mac
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom mia addresses are not supported
