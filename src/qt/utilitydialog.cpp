    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MIA Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MIA Core"));
...
All the MIA in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other mia, without having your coins ever leave your wallet. \
...
These denominations are 0.01 MIA, 0.1 MIA, 1 MIA and 10 MIA -- sort of like the paper money you use every day.</li> \
...
<li>When two other mia send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://MixAir.atlassian.net/wiki/display/DOC/PrivateSend\">https://MixAir.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MIA Core is shutting down...") + "<br /><br />" +
