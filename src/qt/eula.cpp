                              ...
                              isRemembered(false)
{
    ...
    eulaInfo += tr("<p style=\"line-height:130\">To the extent that the Software includes Luxcore Luxgate software, (i) you may customize the \
                   installer for such software in accordance with the restrictions found at <a href=\"https://miacore.io\">https://miacore.io</a> \
                   ...
                   <a href=\"https://miacore.io\">https://miacore.io</a>.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    ...
    eulaInfo += tr("<p style=\"line-height:130\">If the product you have received with this license is pre-commercial release or beta Software (\"Pre-release Software\"), then \
                    ...
                    liability obligations to you of any kind. WHERE LEGALLY LIABILITY CANNOT BE EXCLUDED FOR PRE-RELEASE SOFTWARE, BUT IT MAY BE LIMITED, MIACORE'S LIABILITY AND \
    ...
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">IN NO EVENT WILL MIACORE OR ITS SUPPLIERS BE LIABLE TO YOU FOR ANY DAMAGES, CLAIMS OR COSTS WHATSOEVER OR ANY CONSEQUENTIAL, INDIRECT, \
                   INCIDENTAL DAMAGES, OR ANY LOST PROFITS OR LOST SAVINGS, EVEN IF AN MIACORE REPRESENTATIVE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSS, DAMAGES, CLAIMS OR \
                   COSTS OR FOR ANY CLAIM BY ANY THIRD PARTY. THE FOREGOING LIMITATIONS AND EXCLUSIONS APPLY TO THE EXTENT PERMITTED BY APPLICABLE LAW IN YOUR JURISDICTION. MIACORE'S \
...
void Eula::showDialog()
{
    ...
    QString currentVersion = tr("mia_") + QString::fromStdString(strprintf("%d%d%d%d",
    ...
    if (settings.contains(tr("miaVersion")))
    {
        QString storeVersion = settings.value(tr("miaVersion")).toString();
        ...
        else
        {
            ...
            settings.setValue(tr("miaVersion"), currentVersion);
        }
    }
    else
    {
