    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MIA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MIA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mia: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MIA Core"), this);
    aboutAction->setStatusTip(tr("Show information about MIA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MIA Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MIA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MIA addresses"));
    ...
    openAction->setStatusTip(tr("Open a mia: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MIA Core help message to get a list with possible MIA Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MIA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MIA network", "", count));
    } else {
...
{
    QString strTitle = tr("MIA Core"); // default title
