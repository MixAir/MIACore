...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MIA"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Luxcore help message to get a list with possible MIA command-line options"));
