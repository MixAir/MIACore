...
#ifndef MIA_TRADINGDIALOG_H
#define MIA_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfMIAOnTradingTab();
    ...
    void showBalanceOfMIAOnSendTab();
    void showBalanceOfMIAOnBalanceTab();
    ...
    QString BuyMIA(QString OrderType, double Quantity, double Rate);
    QString SellMIA(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"MIA/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"MIA/BTC\"}"));// "{\"gender\":\"male\"}");
