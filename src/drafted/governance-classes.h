 ...
 *
 *   // network
 *   CMIANetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mixair.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMIANetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MIANetwork
// //   -- signature requirements : Key1(User)
// class CMIANetworkVariable : public CGovernanceObject
// {
// private:
