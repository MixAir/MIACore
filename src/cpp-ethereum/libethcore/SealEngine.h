...
////////////////////////////////////////////////////////////// // mia
	void setLuxSchedule(EVMSchedule _miaSchedule) const { miaSchedule = _miaSchedule; }

	EVMSchedule& getLuxSchedule() const { return miaSchedule; }
...
private:
	...
	mutable EVMSchedule miaSchedule; // mia
