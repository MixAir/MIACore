...
#include "genesis/miaMainNetwork.cpp"
#include "genesis/miaTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::miaMainNetwork: return c_genesisInfoLuxMainNetwork;
	case Network::miaTestNetwork: return c_genesisInfoLuxTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::miaMainNetwork: return c_genesisStateRootLuxMainNetwork;
	case Network::miaTestNetwork: return c_genesisStateRootLuxTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
