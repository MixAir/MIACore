...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lux features */
        {"mia", "masternode", &masternode, true, true, false},
        //{"mia", "masternodelist", &masternodelist, true, true, false},
        //{"mia", "mnbudget", &mnbudget, true, true, false},
        //{"mia", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"mia", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"mia", "mnsync", &mnsync, true, true, false},
        {"mia", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"mia", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
